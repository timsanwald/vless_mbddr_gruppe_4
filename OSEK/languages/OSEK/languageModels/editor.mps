...
<model ref="r:79af1aff-12ca-4d0f-93b0-10ba220c4d8e(OSEK.editor)">
  ...
  <node concept="24kQdi" id="sip4e88sdX">
    ...
    <node concept="3EZMnI" id="sip4e8a1tD" role="2wV5jI">
      <node concept="2iRkQZ" id="sip4e8a1tE" role="2iSdaV" />
      <node concept="3EZMnI" id="sip4e8a1tH" role="3EZMnx">
        <node concept="l2Vlx" id="sip4e8a1tI" role="2iSdaV" />
        <node concept="VPM3Z" id="sip4e8a1tJ" role="3F10Kt">
          <property role="VOm3f" value="false" />
        </node>
        <node concept="3F0ifn" id="sip4e8a1Iw" role="3EZMnx">
